...
export const ITEMS: Record<string, ItemDefinition> = {
  ...
  bell_maul: {
    ...
    category: 'weapon',
    rarity: 'uncommon',
    description: '重击很慢，却能用一记沉重挥击处理贴身威胁。',
    stackLimit: 1,
    sellPrice: 52,
    size: { width: 2, height: 3 },
    stats: { attack: 4, range: 74, attackCooldown: 650 },
  },
  wind_needle: {
    id: 'wind_needle',
    name: '风道细针',
    ...
    category: 'weapon',
    rarity: 'rare',
    description: '出手轻快、距离适中；适合在跳跃和冲刺间持续压制。',
    stackLimit: 1,
    sellPrice: 66,
    size: { width: 1, height: 3 },
    stats: { attack: 2, range: 102, attackCooldown: 270 },
  },
  relay_sabre: {
    id: 'relay_sabre',
    name: '信标弧刃',
    ...
    category: 'weapon',
    rarity: 'relic',
    description: '深场信号铸成的弧刃。攻击与距离兼顾，但每一击都要耐心等待。',
    stackLimit: 1,
    sellPrice: 96,
    size: { width: 2, height: 3 },
    stats: { attack: 3, range: 132, attackCooldown: 520 },
  },
  stream_shell: {
    id: 'stream_shell',
    name: '旧直播甲',
